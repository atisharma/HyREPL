...
HyREPL requires Python3 and Hy over 0.27.0 It is still a work in progress, but it
...
(import HyREPL.middleware.eval :as repl-mw)
...
If you encounter bugs or missing features, please create an [issue](https://github.com/atisharma/HyREPL/issues).
Patches are always welcome.

## Authors

As far as I can trace from the git commit history (in no particular order):
